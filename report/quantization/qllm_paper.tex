...
We evaluate five distinct 4-bit quantization strategies, each representing different algorithmic approaches:
...
GPTQ employs layer-wise quantization minimizing reconstruction error via inverse Hessian information \cite{frantar2023gptq}:
\begin{equation}
\min_{\hat{W}} ||WX - \hat{W}X||_2^2
\end{equation}
where $W$ is the weight matrix and $X$ represents calibration inputs.

\textbf{Configuration:}
\begin{itemize}
\item Bits: 4
\item Group size: 128
\item Dataset: C4 (calibration)
\item Kernel: ExLlamaV2
\end{itemize}
...
Bibliography section - uncomment and fill in when ready
\begin{thebibliography}{99}
\bibitem{jiang2023mistral}
A. Q. Jiang et al., ``Mistral 7B,'' \textit{arXiv preprint arXiv:2310.06825}, 2023.
% 
% \bibitem{frantar2023gptq}
% E. Frantar, S. Ashkboos, T. Hoefler, and D. Alistarh, ``GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers,'' \textit{arXiv preprint arXiv:2210.17323}, 2023.
% 
% \bibitem{lin2023awq}
% J. Lin, J. Tang, H. Wang, et al., ``AWQ: Activation-aware Weight Quantization for LLM Compression and Acceleration,'' \textit{arXiv preprint arXiv:2306.00978}, 2023.
% 
